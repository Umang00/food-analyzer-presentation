        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 mb-16">
          ...
          >
            <div className="mb-4 relative">
              <img
                src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://drive.google.com/file/d/1udtkUch7EtzaglrzaCZvL85J92m_aRlk/view&color=22C55E&bgcolor=0A0A0F"
            ...
            <a
              href="https://drive.google.com/file/d/1udtkUch7EtzaglrzaCZvL85J92m_aRlk/view"
              target="_blank"
